...
Создатели React называют этот подход _one-way data flow_ :
...
Важно: виртуальный DOM — не самоцель React, как многие думают. Это просто эффективный способ реализовать идею _one-way data flow_. Если бы работал вариант с `innerHTML`, то никто бы не делал виртуальный DOM.
