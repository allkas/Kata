...
Можно ли решить эту задачу каким-то другим способом? Оказывается можно. Достаточно использовать полиморфизм подтипов. Для этого создается класс, описывающий пользователя, не прошедшего аутентификацию, например, _Guest_. Затем в него добавляются все необходимые методы, для которых мы хотим получить полиморфное поведение. 
