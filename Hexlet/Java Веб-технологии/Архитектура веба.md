...
#### Самостоятельная работа
  ...
  1. Выполните запрос `curl --head https://hexlet.io`
  2. Изучите отправляемые и возвращаемые заголовки
  3. Откройте консоль разработчика в своем браузере
  4. В консоли перейдите на вкладку _Network_ и загрузите `https://ru.hexlet.io`
  5. Изучите, какие запросы делает сайт, какие заголовки он использует и что приходит в ответ
