...
Таблица _customers_ содержит информацию о покупателях: имя и дату рождения
...
Таблица _products_ содержит информацию о товарах магазина
...
Таблица _orders_ содержит информацию о сделанных покупках
...
Составьте запрос, который найдет 3 покупателей, покупающих больше всего крабов ('Crab'). Выведите также возраст этих покупателей. Итоговая выборка должна содержать поля _customer_name_ , _age_ и _purchase_count_ – количество покупок. Отсортируйте вывод по количеству покупок DESC и имени ASC.
