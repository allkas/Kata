...
Множественные операции в SQL 1 сообщение
...
1) Студенты с количеством баллов 2000 и более (_points_) 2) Преподаватели, которые начали работать до 2023 года (_created_at_) 3) Текущие работники школы (_is_active_)

Итоговая таблица должна содержать поле _full_name_ с именем и фамилией участника акции и поле _role_ с указанием роли

  * _student_ для студента
  * _teacher_ для преподавателя
  * _employee_ для сотрудника.



Отсортируйте записи по _full_name_. Пример итоговой таблицы:
