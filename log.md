...
## [2026-04-24] ingest | Hexlet — JavaScript (27 курсов)

**Создано:** ~470 .md файлов — 341 урок + 101 испытание по 27 JS-курсам

**Курсы:** Функции, Массивы, Коллекции, Деревья, Объекты, Полиморфизм, Погружаясь в классы, Введение в ООП, ОО-дизайн, Составные данные, Абстракция с помощью данных, Программирование управляемое данными, ПО-проектирование, Асинхронное программирование, Разработка абстракций для асинхронности, Автоматическое тестирование, Продвинутое тестирование, Dom Testing Library, Архитектура фронтенда, Обработка ошибок, Веб-разработка, DOM API, React, React Hooks, SQL, Последовательности, Составные данные, Настройка окружения

**Мастер-индекс обновлён:** 916 файлов всего в Hexlet/

---

## [2026-04-24] ingest | Hexlet — общие курсы (19 курсов)

**Создано:** 242 .md файла в `Hexlet/` — 19 курсов по общим темам

**Новые курсы:** Протокол HTTP, HTTP API, Основы SQL, SQL Join, SQL Оконные функции, Множественные операции в SQL, Основы Redis, Docker — Основы, Непрерывная интеграция (CI), Основы алгоритмов и структур данных, Алгоритмы на графах/деревьях, Проектирование баз данных, Продакшен и Деплой, Введение в интернет, Администрирование Linux, Регулярные выражения, Жизненный цикл ПО, Terraform — Основы

**Испытания добавлены:** Основы SQL (3), SQL Join (3), SQL Оконные функции (3), Множественные операции в SQL (3), HTTP API (2), Основы алгоритмов (5), Администрирование Linux (1)

**Обновлены wiki-страницы (добавлен `**Hexlet:**`):** Docker vs VM, Dockerfile и слои образа, CI CD GitLab Jenkins, SQL индексы JOIN нормализация, Транзакции уровни изоляции, SOAP vs REST, Разница HTTP методов, PUT vs PATCH, Алгоритмы на собесе, Бинарное дерево

**Мастер-индекс обновлён:** `Hexlet/Hexlet Java курсы.md` — 431 файл всего

---

## [2026-04-24] ingest | Hexlet — Испытания и тестирование (Java)

**Создано:** 58 задач-испытаний в `Испытания/` внутри 11 Java-курсов
- Каждый файл: описание задачи + `App.java` шаблон + секция `## Моё решение`
- Курс `Java Автоматическое тестирование` дополнен: `Самостоятельная работа`, `Чек-лист хороших инженерных практик`
- Индексы испытаний добавлены в каждый курс
